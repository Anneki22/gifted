...
global.caption = "*©𝟐𝟎𝟐𝟒 死_ＮＥＭＥＳＩＸ*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~Xjp0QLga#7EnXRB_4MDKHces-0taU92oZT2AGpq2y8viFKFrMDsw", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "false",
AUTO_LIKE_STATUS: process.env.AUTO_LIKE_STATUS || "fals",
...
OWNER_NAME: process.env.OWNER_NAME || "死_ＮＥＭＥＳＩＸ", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "死_ＮＥＭＥＳＩＸ", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "ENMA-MD💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "ENMA-𝐌𝐃", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://ibb.co/LN2vJ14", // You can Replace with yours...
